...
<header class="site-header">
            ...
            <div class="">
                <form method="post" class="">
                    <select name="type"  required>
                            ...
                            <input type="submit" name="btnsubmit" value="Serach">
                            <a href="blog.php"><button class="">show all</button></a>
                </form>
            </div>
           <br>
            <div class="row">
  ...
  <div class="card-body">
				...
				<?php
                                                ...
                                                {
                                                    $type=$_REQUEST['type'];
                                                    $sel = "select * from stuff where status='Approved' and type='$type' order by sid ASC";
                                                    $res = mysqli_query($con,$sel);
                                                }
                                                else
                                                {
                                                    $sel = "select * from stuff where status='Approved' order by sid ASC";
                                                    $res = mysqli_query($con,$sel);    
                                                }	
				...
				<div>
                                ...
                                <div class="card">
                                      <div class="card-body">
                                        <h4 class="card-title"><a href="blog_des?id=<?php echo $row['sid']?>" class="card-link" style="color:blue"><b style="color:blue"><?php echo $row['title'] ?></b></a></h4>
                                        <p class="card-text"><b style="color:#CC3300"><?php echo $row['type'] ?></b></p>
                                        <p class="card-text"><?php echo substr($row['descp'],0,100) ?>....</p>
