...
<section class="activities">
	<div class="container">
        <div class="col-md-12">
           ...
           <div class="main" >
            <div>
                <?php if(isset($_SESSION['user']))
                {
                    ...
                    &nbsp;&nbsp;&nbsp;
                    <a href="activities.php"><button class="">show all</button></a>
           ...
           <div class="row" >
                                                ...
                                                {
                                                    $sel = "select * from patrika order by pid ASC";
                                                    $res = mysqli_query($con,$sel);    
                                                }
    ...
    <div class="content">
      <iframe style="height:300px" src="<?php echo $row['ifream'] ?>" seamless="seamless" scrolling="no" frameborder="0" allowtransparency="true" allowfullscreen="true"></iframe>&nbsp;&nbsp;&nbsp;
      <h5><b><?php echo $row['title']; ?> - <?php echo $row['year']; ?></b></h5>
    </div>
                                            ...
                                            else
                                            {
                                                ...
                                                <div class="card col-md-12">
                                                  ...
                                                  <div class="card-body">
                                                    ...
                                                    ?>
                                                      <form method="post">
                                                        userName:<input type="text" name="txtusername" required="" class="form-control">
                                                        Password:<input type="password" name="txtpassword" required="" class="form-control">
                                                  </div>
                                                  <div class="card-footer"><input type="submit" name="btnlogin"></div>
                                                      </form>
                                                </div>
                                                <?php
                                                }
