        ...
        <div class="col-md-12">
         ...
         <div class="row">
		  <?php
		                                        $ab=$_REQUEST['a'];
												$i = 1;
												$sel = "select * from gallery_album where gaid='$ab' ";
				...
				<div class="col-md-3 col-xs-6 ">
					<div class="grid effect-apollo"> 
						<a  href="C-Panel/Upload_image/<?php echo $row['album']; ?>" data-lightbox="example-set" >
							 <img src="C-Panel/Upload_image/<?php echo $row['album']; ?>" alt="Gallery" style="width:300px; height:300px" class="img-fluid">								
						</a> 
					</div>
				</div>	
