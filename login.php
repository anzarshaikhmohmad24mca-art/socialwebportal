...
session_start();
	...
	if(isset($_REQUEST['btn_submit']))
	{
		...
		$sel1 = "select * from registration where email = '$unm' AND password = '$pwd'";
...
<header class="site-header">
    ...
    <div class="contact-page-wrap">
        <div class="container">
            <div class="row">
				...
				<div class="contact-form">
                    <form method="post">
                                  <input type="text" name="txt_unm" placeholder="Enter Email Id" style="background-color:white" required class="form-control" />
		...
		<br>
        </div><!-- .container --><center><a href="registration.php" class="btn btn-success" style="color:white">*** New User Registration</a></center>
    </div>
