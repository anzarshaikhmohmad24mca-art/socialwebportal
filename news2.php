        ...
        <div class="container">
            <div class="row">
				...
				<div class="contact-form">
                                ...
                                Title:<textarea name="name2" class="form-control" style="height:100px"><?php echo $row['title'] ?></textarea></b>
                                
								Description:<textarea name="name2" class="form-control" style="height:400px"><?php echo $row['descrip'] ?></textarea></b>
